$(document).ready(function(){
        ...
        function pageLoader() {
            ...
            $(".main-holder").append('<article class="col-md-12"><img class="show-img col-sm-4 img-responsive" src="' + dados.crime[id].image + '" alt=""><div class="show-info col-sm-6  centralize"><h1 class="show-title">' +
